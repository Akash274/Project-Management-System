...
<br>
	...
	<tr class="sa"><td>Module Name:</td><td><input type="text" name="Mname" required></td></tr>

	<tr class="sa"><td><select id="tlID" onchange="if (this.selectedIndex) changeName(this);" required>
	...
	<tr class="sa"><td>Team Leader Name:&nbsp;</td><td><input type="text" name="leaderName" id="leaderName" onkeydown="Check(event);" required></td></tr>
	<tr class="sa"><td>Team Leader Id:&nbsp;</td><td><input type="text" name="leaderID" id="leaderID" onkeydown="Check(event);"  required></td></tr>
	<script>
		function Check(e) {
	...
	<tr class="sa"><td>Start Date</td><td><input type="date" name="startDate" required value="2016-10-2" /></td></tr>
	<tr class="sa"><td>End Date</td><td><input type="date" name="endDate" required value="2016-10-2" /></td></tr></table>
...
<div id="addProject" style="visibility:hidden;">
	...
	<div class="element-main">
		...
		<center>
			<input type="text"  onfocus="this.value = '';"  onblur="	if(!isNaN(this.value)){this.style.borderBottom='thick solid red '; document.getElementById('err').style.display='inline';}else{this.style.borderBottom='none'; document.getElementById('err').style.display='none';}" name="projectName" placeholder="Project Name" required>
			<span id="err" style="display:none">Project name should not be number only</span><br>Start Date<br><input type="date" name="startDate" value="2016-10-2" required style="font-size: 1em;
    color: #404040;
	margin-top:10px;
    padding: 1em 0.5em;
    display: block;
	...
	border-radius: 2px;
			" />
			End Date<input type="date" name="endDate" value="2016-10-2" required style="font-size: 1em;
    color: #404040;
	margin-top:10px;
    padding: 1em 0.5em;
    display: block;
